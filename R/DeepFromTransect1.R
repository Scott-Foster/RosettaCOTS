...
predDeepFromTransect <- function( transect_density=newDensity, pred_type="PI", intLevel=0.95){
  ...
  fm.post <- readRDS( system.file("extdata", "samples_DeepFromTransects.RDS", package="RosettaCOTS"))
#  fm.post <- readRDS( samples_DeepFromTransects.RDS")
  ...
  colnames( tmptmp) <- c( "transect_density","DeepFromTransect_coral","coral_lower","coral_medain","coral_upper")
