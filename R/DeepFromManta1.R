...
predDeepFromManta <- function( manta_perc, pred_type="PI", intLevel=0.95){
  ...
  fm.post <- readRDS( system.file("extdata", "samples_DeepFromManta.RDS", package="RosettaCOTS"))
#  fm.post <- readRDS( samples_DeepFromManta.RDS")
  ...
  colnames( tmptmp) <- c( "manta_perc","DeepFromManta_coral","coral_lower","coral_median","coral_upper")
