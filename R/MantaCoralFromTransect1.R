...
predMantaCoralFromTransect <- function( transect_density=newDensity, pred_type="PI", intLevel=0.95){
  ...
  fm.post <- readRDS( system.file("extdata", "samples_MantaCoralFromTransects.RDS", package="RosettaCOTS"))
#  fm.post <- readRDS( samples_MantaCoralFromTransects.RDS")
  ...
  colnames( tmptmp) <- c( "transect_density","MantaFromTransect_coral","coral_lower","coral_median","coral_upper")
