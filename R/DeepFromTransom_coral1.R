...
predDeepFromTransom <- function( transom_perc=newDensity, pred_type="PI", intLevel=0.95){
  ...
  fm.post <- readRDS( system.file("extdata", "samples_DeepFromTransom.RDS", package="RosettaCOTS"))
#  fm.post <- readRDS( samples_DeepFromTransom.RDS")
  ...
  colnames( tmptmp) <- c( "transom_perc","DeepFromTransom_perc","coral_lower","coral_median","coral_upper")
